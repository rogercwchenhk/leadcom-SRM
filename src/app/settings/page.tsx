...
import { UsersRound, Shield, Building2 } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            <p className="text-sm text-slate-500 mt-1">管理组织架构、用户权限和系统配置</p>
          </div>

          <Card className="border-slate-200 shadow-sm">
            <CardHeader className="pb-4">
              <CardTitle className="text-sm font-semibold text-slate-900">系统管理</CardTitle>
                ...
                <div className="mb-6 overflow-x-auto -mx-2 sm:mx-0 pb-2">
                  <TabsList className="grid-cols-3 w-full min-w-max sm:w-auto">
                    ...
                    <TabsTrigger value="users" className="gap-1 sm:gap-2 text-xs sm:text-sm">
                      ...
                      <span className="hidden sm:inline">用户与用户组</span>
