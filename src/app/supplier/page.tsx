                          ...
                          <TabsContent value="basic" className="space-y-4 py-4">
                            <div className="p-3 border rounded-lg bg-slate-50 space-y-3">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                <div className="grid gap-1">
                                  <Label htmlFor="contactPerson" className="text-[9px]">
                                ...
                                <div className="grid gap-1">
                                  <Label htmlFor="phone" className="text-[9px]">联系电话</Label>
                                  <Input
                                    id="phone"
                              ...
                              <div className="grid gap-1">
                                <Label htmlFor="email" className="text-[9px]">电子邮箱</Label>
                                <Input
                                  id="email"
                                  type="email"
                              ...
                              <div className="grid gap-1">
                                <Label htmlFor="businessLicenseNumber" className="text-[9px]">
                                  营业执照号
                                </Label>
                                <Input
                              ...
                              <div className="grid gap-1">
                                <Label htmlFor="registeredAddress" className="text-[9px]">
                                  注册地址
                                </Label>
                                <Textarea
                              ...
                              <div className="grid gap-1">
                                <Label htmlFor="address" className="text-[9px]">
                                  经营地址
                                </Label>
                                <Textarea
                                  id="address"
                              ...
                              <div className="grid gap-1">
                                <Label htmlFor="businessScope" className="text-[9px]">
                                  经营范围
                                </Label>
                                <Textarea
                                  id="businessScope"
                              ...
                              <div className="grid gap-1">
                                <Label htmlFor="categories" className="text-[9px]">
                                  经营类别 <span className="text-[9px] text-slate-500">(多个类别用逗号分隔)</span>
                                </Label>
                                <Input
                                  id="categories"
