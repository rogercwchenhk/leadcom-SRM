                      ...
                      <div className="border-t border-slate-200 bg-slate-50">
                        <div className="p-2.5 space-y-2">
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="bg-white p-2 rounded border border-slate-200 space-y-1.5">
                              <div className="flex items-start gap-1 text-[10px]">
                                <Mail className="w-3 h-3 text-slate-400 mt-0.5" />
                                <span className="text-slate-600">邮箱：</span>
                                <span className="text-slate-900 truncate flex-1">{supplier.email}</span>
                              </div>
                              {supplier.address && (
                                <div className="flex items-start gap-1 text-[10px]">
                                  <MapPin className="w-3 h-3 text-slate-400 mt-0.5" />
                                  <span className="text-slate-600">地址：</span>
                                  <span className="text-slate-900 flex-1 leading-relaxed">{supplier.address}</span>
                                </div>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-4 gap-1">
                            <div className="bg-white p-1.5 rounded border border-slate-200 text-center">
                              <div className="text-xs font-bold text-slate-900">{supplier.historicalCooperationCount}</div>
                              <div className="text-[9px] text-slate-500">合作次数</div>
                            </div>
                            <div className="bg-white p-1.5 rounded border border-slate-200 text-center">
                              <div className="text-xs font-bold text-slate-900">{supplier.averageDeliveryDays}</div>
                              <div className="text-[9px] text-slate-500">平均货期</div>
                            </div>
                            <div className="bg-white p-1.5 rounded border border-slate-200 text-center">
                              <div className="text-xs font-bold text-slate-900">¥{(supplier.totalTransactionAmount / 1000).toFixed(0)}K</div>
                              <div className="text-[9px] text-slate-500">累计金额</div>
                            </div>
                            <div className="bg-white p-1.5 rounded border border-slate-200 text-center">
                              <div className="text-xs font-bold text-slate-900">{supplier.lastTransactionDate}</div>
